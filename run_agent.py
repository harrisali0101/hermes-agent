...
class AIAgent:
    ...
    def _run_claude_code_cli_turn(
        ...
        *,
        ...
        """Forwarder — see ``agent.claude_code_runtime.run_claude_code_cli_turn``."""
        from agent.claude_code_runtime import run_claude_code_cli_turn
        return run_claude_code_cli_turn(self, user_message=user_message, original_user_message=original_user_message, messages=messages, effective_task_id=effective_task_id, should_review_memory=should_review_memory)
